...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /home/runner/micromamba/envs/scpy_docs/lib/python3.12/site-packages/spectrochempy/utils/decorators.py:98: DeprecationWarning:  The `max_components` attribute is now deprecated. Use `n_components` instead. `max_components` attribute will be removed in version 0.7. 
      output_warning_message(name, kind, replace, removed, extra_msg)
    /home/runner/micromamba/envs/scpy_docs/lib/python3.12/site-packages/traitlets/traitlets.py:1568: UserWarning: SIMPLISMA does not handle easily negative values.
      c(event)
    ...
    <spectrochempy.analysis.decomposition.simplisma.SIMPLISMA object at 0x7fc6511dc470>
