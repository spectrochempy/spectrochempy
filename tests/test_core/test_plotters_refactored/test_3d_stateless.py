...
class Test3DStateless:
    ...
    def test_3d_surface_creation(self, sample_3d_dataset):
        ...
        assert '3d' in ax_name.lower() or hasattr(ax, 'zaxis'), "Should have 3D projection"
        ...
        assert has_surface or len(ax.collections) > 0, "Surface plot should create surface mesh"
