...
class TestDocstringsPlaintext:
    ...
    def test_no_template_placeholders_in_plot1d(self):
        ...
        from spectrochempy.plotting.plot1d import plot_1D, plot_pen, plot_scatter
    ...
    def test_no_template_placeholders_in_plot3d(self):
        ...
        from spectrochempy.plotting.plot3d import plot_3D, plot_surface, plot_waterfall
