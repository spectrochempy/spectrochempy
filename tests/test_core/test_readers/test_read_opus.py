...
class TestOpusBasic:
    ...
    def test_single_file(self):
        ...
        dataset = read_opus(OPUSDATA / "test.0000")
    ...
    def test_read_from_contents(self):
        ...
        dataset = read_opus({p.name: content})
...
class TestOpusMetadata:
    ...
    def setup_method(self):
        ...
        self.dataset = read_opus(OPUSDATA / "test.0000")
...
class TestOpusMerging:
    ...
    def test_merge_flag_behavior(self):
        ...
        # Test merge=True
        merged = read_opus(OPUSDATA / "test.0000", OPUSDATA / "test.0001", merge=True)
