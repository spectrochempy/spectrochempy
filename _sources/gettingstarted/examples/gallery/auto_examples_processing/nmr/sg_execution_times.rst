...
Computation times
=================
**00:07.245** total execution time for 5 files **from gettingstarted/examples/gallery/auto_examples_processing/nmr**:
...
.. container::
   ...
   * - Example
     - Time
     - Mem (MB)
   * - :ref:`sphx_glr_gettingstarted_examples_gallery_auto_examples_processing_nmr_plot_processing_nmr_2d.py` (``plot_processing_nmr_2d.py``)
     - 00:03.516
     - 0.0
