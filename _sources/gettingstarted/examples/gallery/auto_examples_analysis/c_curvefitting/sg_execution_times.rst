...
Computation times
=================
**00:01.697** total execution time for 3 files **from gettingstarted/examples/gallery/auto_examples_analysis/c_curvefitting**:
...
.. container::
   ...
   * - :ref:`sphx_glr_gettingstarted_examples_gallery_auto_examples_analysis_c_curvefitting_plot_lstsq_single_equation.py` (``plot_lstsq_single_equation.py``)
     - 00:00.342
     - 0.0
   * - :ref:`sphx_glr_gettingstarted_examples_gallery_auto_examples_analysis_c_curvefitting_plot_lineshapes.py` (``plot_lineshapes.py``)
     - 00:00.286
     - 0.0
