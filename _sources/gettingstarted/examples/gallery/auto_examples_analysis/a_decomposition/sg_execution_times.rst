...
Computation times
=================
**00:23.572** total execution time for 11 files **from gettingstarted/examples/gallery/auto_examples_analysis/a_decomposition**:
...
.. container::
   ...
   * - :ref:`sphx_glr_gettingstarted_examples_gallery_auto_examples_analysis_a_decomposition_plot_mcrals_chrom1.py` (``plot_mcrals_chrom1.py``)
     - 00:00.635
     - 0.0
   * - :ref:`sphx_glr_gettingstarted_examples_gallery_auto_examples_analysis_a_decomposition_plot_synthetic_profiles.py` (``plot_synthetic_profiles.py``)
     - 00:00.396
     - 0.0
