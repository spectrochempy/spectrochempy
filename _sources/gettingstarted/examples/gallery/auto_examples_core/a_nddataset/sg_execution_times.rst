...
Computation times
=================
**00:05.355** total execution time for 5 files **from gettingstarted/examples/gallery/auto_examples_core/a_nddataset**:
...
.. container::
   ...
   * - :ref:`sphx_glr_gettingstarted_examples_gallery_auto_examples_core_a_nddataset_plot_c_units.py` (``plot_c_units.py``)
     - 00:00.774
     - 0.0
   * - :ref:`sphx_glr_gettingstarted_examples_gallery_auto_examples_core_a_nddataset_plot_d_slicing.py` (``plot_d_slicing.py``)
     - 00:00.621
     - 0.0
