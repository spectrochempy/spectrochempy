...
.. raw:: html
    ...
    <div class="scp-output section"><div class="attr-name">size</div><div>:</div><div class="attr-value">5549</div></div><div class="scp-output section"><div class="attr-name">title</div><div>:</div><div class="attr-value">wavelength</div></div><div class="scp-output section"><div class="attr-name">coordinates</div><div>:</div><div class="attr-value"> <div class="numeric">[    1667     1667 ... 1.536e+04 1.538e+04] nm</div></div></div>
    </details></div>
    </div>
    <br />
    <br />
