# ======================================================================================
# Vendored from nmrglue.fileio.bruker (BSD 3-Clause, Jonathan J. Helmus).
#
# Read-only subset: binary (ser/fid) reading, JCAMP-DX parameter parsing,
# pulse program parsing, universal dictionary helpers.
#
...
"""
Functions for reading Bruker NMR files.

Binary (ser/fid) files, JCAMP-DX parameter (acqus) files, and
pulse program files.
"""
...
from ._base import complexify_data
