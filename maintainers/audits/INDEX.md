...
This index lists the promoted historical audits stored in this directory.

These documents are **historical context**, not current authority. For the
maintained contract, see [`../rfcs/INDEX.md`](../rfcs/INDEX.md) and
