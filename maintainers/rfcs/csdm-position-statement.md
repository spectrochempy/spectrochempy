...
This document records the maintained project position on the architectural role
of CSDM in SpectroChemPy.

## Scope

Architectural role of the Core Scientific Dataset Model (CSDM) in
SpectroChemPy.
...
This position is informed by the recent maintainer evaluation of CSDM
interoperability and native-persistence candidates.
