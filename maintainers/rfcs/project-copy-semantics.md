...
This document is the maintained RFC for `Project.copy()` semantics.
...
The core invariants RFC has been fully implemented (PRs #1230–#1234). Copy
semantics was explicitly deferred there and is the subject of this RFC.

## Prerequisite Analysis

This RFC follows the completed maintainer review of `Project` copy behavior and
