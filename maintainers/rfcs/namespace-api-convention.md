...
This document defines the maintained namespace-based public API convention for
I/O and domain-specific operations across core and plugins.
...
6. **How does this interact with the vendor I/O migration roadmap?**
   ...
   The vendor I/O migration work moves implementation from core to plugin.
   This RFC ensures that such migrations do not change the public API.  The
...
- private vendor I/O migration planning — the migration moves implementation;
  this RFC stabilizes the public API across that boundary.
- **`reader-metadata-normalization-contract.md`** — defines
...
- **`../architecture/reader-normalization-architecture.md`** — defines
