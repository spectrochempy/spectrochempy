...
This historical RFC preserves the conceptual background for the later result
object architecture work.

## Implementation Reference

[`result-object-architecture.md`](../architecture/result-object-architecture.md)

## Background

Maintainer analysis and campaign-local audit work informed this conceptual RFC.
