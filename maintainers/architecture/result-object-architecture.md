...
Implemented architectural contract.

This document is the maintained architecture reference for result-object
ownership, lifecycle boundaries, and display scope.
...
[`../rfcs/analysis-fit-result-architecture.md`](../rfcs/analysis-fit-result-architecture.md)
