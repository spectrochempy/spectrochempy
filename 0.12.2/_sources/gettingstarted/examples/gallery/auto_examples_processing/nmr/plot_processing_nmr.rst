...
.. raw:: html
    ...
    <div class="scp-output section"><div class="attr-name">created</div><div>:</div><div class="attr-value">2026-08-16 02:58:13+00:00</div></div>
    <div class="scp-output section"><div class="attr-name">history</div><div>:</div><div class="attr-value">2026-08-16 02:58:13+00:00> Imported from TopSpin dataset<br/>2026-08-16 02:58:13+00:00> `em` apodization performed on dimension `x` with parameters: {'lb': <Quantity(2.0, 'hertz')>}<br/>2026-08-16 02:58:13+00:00> `zf_size` shift performed on dimension `x` with parameters: {'size': 16384}<br/>2026-08-16 02:58:13+00:00> `zf_size` shift performed on dimension `x` with parameters: {'size': 16384}<br/>2026-08-16 02:58:13+00:00> Fft applied on dimension x<br/>2026-08-16 02:58:13+00:00> Inplace binary op: imul  with `[    0.61+0.793j     0.61+0.793j ...    0.813+0.582j    0.813+0.582j]` <br/>2026-08-16 02:58:13+00:00> `pk` applied to dimension `x` with parameters: {'phc0': 52.43836, 'phc1': -16.8366, 'pivot': 0.0, 'exptc': 0.0}</div></div>
