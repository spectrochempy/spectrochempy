...
from .util import (logger, UnitsContainer, SharedRegistryObject,
                   ...
                   fix_str_conversions)
from spectrochempy.extern.pint.compat import Loc
...
class _Quantity(SharedRegistryObject):
    ...
    def ito_reduced_units(self):
        ...
        for unit1, exp in list(self._units.items()):
    ...
    def to_compact(self, unit=None):
        ...
        SI_prefixes = {}
        for prefix in list(self._REGISTRY._prefixes.values()):
            try:
    ...
    def _get_non_multiplicative_units(self):
        ...
        """
        offset_units = [unit for unit in list(self._units.keys())
    ...
    def _get_delta_units(self):
        ...
        """
        delta_units = [u for u in list(self._units.keys()) if u.startswith("delta_")]
        return delta_units
    ...
    def _ok_for_muldiv(self, no_offset_units=None):
        ...
        if no_offset_units == 1:
            ...
            if (len(self._units) == 1
                ...
                is_ok = False
            if next(iter(list(self._units.values()))) != 1:
                is_ok = False
        return is_ok
