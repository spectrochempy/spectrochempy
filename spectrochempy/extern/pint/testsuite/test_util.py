...
from spectrochempy.extern.pint.testsuite import BaseTestCase, QuantityTestCase
from spectrochempy.extern.pint.util import (string_preprocessor, find_shortest_path, matrix_to_string,
...
class TestToUnitsContainer(BaseTestCase):
    ...
    def test_quantity_conversion(self):
        from spectrochempy.extern.pint.registry import UnitRegistry
        ureg = UnitRegistry()
        self.assertEqual(to_units_container(ureg.Quantity(1, UnitsContainer(m=1))),
                         UnitsContainer(m=1))

    def test_unit_conversion(self):
        from spectrochempy.extern.pint.unit import _Unit
