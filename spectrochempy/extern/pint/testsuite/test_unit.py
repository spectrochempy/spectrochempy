...
from spectrochempy.extern.pint.registry import (UnitRegistry, LazyRegistry)
from spectrochempy.extern.pint.util import (UnitsContainer, ParserHelper)
from spectrochempy.extern.pint import DimensionalityError, UndefinedUnitError
from spectrochempy.extern.pint.compat import u, np, string_types
from spectrochempy.extern.pint.testsuite import QuantityTestCase, helpers
from spectrochempy.extern.pint.testsuite.parameterized import ParameterizedTestCase
...
class TestRegistry(QuantityTestCase):
    ...
    def test_load(self):
        ...
        from spectrochempy.extern.pint import unit
...
class TestRegistryWithDefaultRegistry(TestRegistry):
    ...
    @classmethod
    def setUpClass(cls):
        from spectrochempy.extern.pint import _DEFAULT_REGISTRY
