...
from spectrochempy.extern.pint import DimensionalityError, OffsetUnitCalculusError, UnitRegistry
from spectrochempy.extern.pint.unit import UnitsContainer
from spectrochempy.extern.pint.compat import string_types, PYTHON3, np
