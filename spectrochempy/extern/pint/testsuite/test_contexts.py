...
from spectrochempy.extern.pint import UnitRegistry, errors
from spectrochempy.extern.pint.context import Context
from spectrochempy.extern.pint.util import UnitsContainer
...
class TestDefinedContexts(QuantityTestCase):
    ...
    def test_spectroscopy(self):
        ...
        with ureg.context('sp'):
            from spectrochempy.extern.pint.util import find_shortest_path
