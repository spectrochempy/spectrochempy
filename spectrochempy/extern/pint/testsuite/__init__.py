...
from spectrochempy.extern.pint.compat import ndarray, np

from spectrochempy.extern.pint import logger, UnitRegistry
from spectrochempy.extern.pint.quantity import _Quantity
from spectrochempy.extern.pint.testsuite.helpers import PintOutputChecker
...
def testsuite():
    ...
    from spectrochempy.extern.pint.compat import HAS_NUMPY, HAS_UNCERTAINTIES
