...
Examples:
  ...
  from spectrochempy.extern.uncertainties import ufloat
  from spectrochempy.extern.uncertainties.umath import *  # sin(), etc.
...
uncertainties.umath module:
  ...
  from spectrochempy.extern.uncertainties.umath import sin
