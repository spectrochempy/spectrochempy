...
class ProgressDialog(QtGui.QProgressDialog) :
    ...
    def __init__(self, labelText, minimum=0, maximum=100, cancelText='Cancel',
                 parent=None, wait=250, busyCursor=False, disable=False) :
        """
        ==============
        ================================================================
        **Arguments:**
        ...
        disable        If True, the progress dialog will not be displayed
                       ...
                       If ProgressDialog is entered from a non-gui thread,
                       it will
                       always be disabled.
        ==============
        ================================================================
        ...
        QtGui.QProgressDialog.__init__(self, labelText, cancelText, minimum,
                                       maximum, parent)
    ...
    ## wrap all other functions to make sure they aren't being called from
    # non-gui threads
