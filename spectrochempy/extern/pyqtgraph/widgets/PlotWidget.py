# -*- coding: utf-8 -*-
"""
PlotWidget.py -  Convenience class--GraphicsView widget displaying a single
PlotItem
...
class PlotWidget(GraphicsView) :
    ...
    def __init__(self, parent=None, background='default', **kargs) :
        """When initializing PlotWidget, *parent* and *background* are
        passed to
        ...
        # QtCore.QObject.connect(self.plotItem, QtCore.SIGNAL(
        # 'viewChanged'), self.viewChanged)
