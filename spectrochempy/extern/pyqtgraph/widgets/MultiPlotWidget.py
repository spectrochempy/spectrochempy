# -*- coding: utf-8 -*-
"""
MultiPlotWidget.py -  Convenience class--GraphicsView widget displaying a
MultiPlotItem
...
class MultiPlotWidget(GraphicsView) :
    """Widget implementing a graphicsView with a single MultiPlotItem
    inside."""
    ...
    def resizeEvent(self, ev) :
        ...
        MultiPlotWidget.setRange(self, self.range, padding=0,
                                 disableAutoPixel=False)  ## we do this
        # because some subclasses like to redefine setRange in an incompatible way.
        self.updateMatrix()
