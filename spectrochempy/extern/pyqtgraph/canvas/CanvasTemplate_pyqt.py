...
# 'acq4/pyqtgraph/canvas/CanvasTemplate.ui'
#
...
class Ui_Form(object) :
    def setupUi(self, Form) :
        ...
        sizePolicy.setHeightForWidth(
            self.autoRangeBtn.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setHeightForWidth(
            self.itemList.sizePolicy().hasHeightForWidth())
        ...
        self.reflectSelectionBtn.setObjectName(
            _fromUtf8("reflectSelectionBtn"))
    ...
    def retranslateUi(self, Form) :
        ...
        self.autoRangeBtn.setText(
            QtGui.QApplication.translate("Form", "Auto Range", None,
                                         QtGui.QApplication.UnicodeUTF8))
        self.redirectCheck.setToolTip(QtGui.QApplication.translate("Form",
                                                                   "Check to "
                                                                   "display "
                                                                   "all "
                                                                   "local "
        ...
        self.redirectCheck.setText(
            QtGui.QApplication.translate("Form", "Redirect", None,
                                         QtGui.QApplication.UnicodeUTF8))
        self.resetTransformsBtn.setText(
            QtGui.QApplication.translate("Form", "Reset Transforms", None,
                                         QtGui.QApplication.UnicodeUTF8))
        self.mirrorSelectionBtn.setText(
            QtGui.QApplication.translate("Form", "Mirror Selection", None,
                                         QtGui.QApplication.UnicodeUTF8))
        self.reflectSelectionBtn.setText(
            QtGui.QApplication.translate("Form", "MirrorXY", None,
                                         QtGui.QApplication.UnicodeUTF8))
