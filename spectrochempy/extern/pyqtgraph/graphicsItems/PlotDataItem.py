    ...
    **Signals:**
    ...
    def __init__(self, *args, **kargs):
        ...
        **Data initialization arguments:** (x,y data AND may include spot style)
            ...
            PlotDataItem(MetaArray)       1D array of Y values with X specified as axis values
    ...
    def setData(self, *args, **kargs):
        ...
        if len(args) == 1:
            ...
            seq = ('listOfValues', 'MetaArray', 'NDDataset', 'empty')
...
def dataType(obj):
    ...
    if isinstance(obj, dict):
        ...
        if hasattr(obj, 'implements'):
            if obj.implements('MetaArray'):
                return 'MetaArray'

            # TODO: try to replace all Metaarray by NDDataset
            elif obj.implements('NDDataset'):
                return 'NDDataset'
...
def isSequence(obj):
    return hasattr(obj, '__iter__') or isinstance(obj, np.ndarray) \
           or (hasattr(obj, 'implements')
           and (obj.implements('MetaArray') or obj.implements('NDDataset')))
