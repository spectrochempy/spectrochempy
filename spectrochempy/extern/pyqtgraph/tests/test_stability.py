...
Create lots of random widgets and graphics items, connect them together
randomly,
...
def crashtest() :
    ...
    try :
        gc.disable()
        actions = [createWidget,  # setParent,
            forgetWidget, showWidget, processEvents,
            # raiseException,# addReference,]
