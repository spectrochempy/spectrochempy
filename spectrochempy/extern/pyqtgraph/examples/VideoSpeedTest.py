...
from spectrochempy.extern.pyqtgraph.Qt import QtGui, QtCore, USE_PYSIDE, USE_PYQT5
import numpy as np
import spectrochempy.extern.pyqtgraph as pg
import spectrochempy.extern.pyqtgraph.ptime as ptime
...
try:
    from spectrochempy.extern.pyqtgraph.widgets.RawImageWidget import RawImageGLWidget
except ImportError:
