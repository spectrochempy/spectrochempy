...
from spectrochempy.extern.pyqtgraph.Qt import QtGui, USE_PYSIDE, USE_PYQT5
...
class ExampleLoader(QtGui.QMainWindow) :
    def __init__(self) :
        ...
        self.codeLayout.addItem(
            QtGui.QSpacerItem(100, 100, QtGui.QSizePolicy.Expanding,
                              QtGui.QSizePolicy.Expanding), 0, 0)
    ...
    def populateTree(self, root, examples) :
        for key, val in examples.items() :
            ...
            self.itemCache.append(
                item)  # PyQt 4.9.6 no longer keeps references to these
            # wrappers,
    ...
    def loadFile(self, edited=False) :
        ...
        if edited :
            ...
            proc = subprocess.Popen([sys.executable, '-'] + extra,
