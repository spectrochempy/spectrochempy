...
from spectrochempy.extern.pyqtgraph.widgets.RemoteGraphicsView import RemoteGraphicsView
app = pg.mkQApp()
...
## v.pg is a proxy to the remote process' spectrochempy.extern.pyqtgraph module. All attribute
## requests and function calls made with this object are forwarded to the
## remote process and executed there. See spectrochempy.extern.pyqtgraph.multiprocess.remoteproxy
## for more inormation.
plt = v.pg.PlotItem()
