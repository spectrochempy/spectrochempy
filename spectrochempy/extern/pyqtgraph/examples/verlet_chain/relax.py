...
if COMPILED :
    lib.relax.argtypes = [ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p,
    ...
    def relax(pos, links, mrel1, mrel2, lengths, push, pull, iters) :
        ...
        lib.relax(pos.ctypes, links.ctypes, mrel1.ctypes, mrel2.ctypes,
                  lengths.ctypes, push.ctypes, pull.ctypes, nlinks, iters)
    ...
    def relax(pos, links, mrel1, mrel2, lengths, push, pull, iters) :
        ...
        for i in range(iters) :
            ...
            for l in range(links.shape[0]) :
                ...
                if (push[l] and dist2 < lengths2[l]) or (
                    pull[l] and dist2 > lengths2[l]) :
                    dist = dist2 ** 0.5
