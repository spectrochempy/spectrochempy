...
text = """
This is an interactive python console. The numpy and spectrochempy.extern.pyqtgraph modules have already been imported 
as 'np' and 'pg'. 

Go, play.
"""
c = spectrochempy.extern.pyqtgraph.console.ConsoleWidget(namespace=namespace, text=text)
c.show()
