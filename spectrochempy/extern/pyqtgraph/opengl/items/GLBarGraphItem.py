...
class GLBarGraphItem(GLMeshItem) :
    def __init__(self, pos, size) :
        ...
        cubeVerts = np.mgrid[0 :2, 0 :2, 0 :2].reshape(3,
                                                       8).transpose().reshape(
            1, 8, 3)
        cubeFaces = np.array(
                [[0, 1, 2], [3, 2, 1], [4, 5, 6], [7, 6, 5], [0, 1, 4],
                    [5, 4, 1], [2, 3, 6], [7, 6, 3], [0, 2, 4], [6, 4, 2],
        ...
        md = MeshData(verts.reshape(nCubes * 8, 3),
                      faces.reshape(nCubes * 12, 3))
