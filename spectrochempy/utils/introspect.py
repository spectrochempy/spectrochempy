...
"""Functions related to Python runtime introspect."""
...
def resolve_name(name, *additional_parts):
    ...
    >>> resolve_name('spectrochempy.utils.introspect.resolve_name')
...
def minversion(module, version, inclusive=True, version_path='__version__'):
    ...
    >>> minversion(spectrochempy, '0.4.4')
    True
    """
...
def find_current_module(depth=1, finddiff=False):
    ...
    depth : int
        ...
        passing in 0 gives back `spectrochempy.utils.misc`).
    ...
    ``pkg``. ``mod1.py``::
        ...
        def find1():
            from spectrochempy.utils import find_current_module
    ...
    With these modules in place, the following occurs::
        ...
        <module 'spectrochempy.utils.misc' from 'spectrochempy/utils/misc.py'>
        >>> mod1.find_diff()
        pkg.mod1
...
def find_mod_objs(modname, onlylocals=False):
    ...
    fqnames : list of str
        ...
        ``spectrochempy.utils.introspect.find_mod_objs``). For attributes that are
