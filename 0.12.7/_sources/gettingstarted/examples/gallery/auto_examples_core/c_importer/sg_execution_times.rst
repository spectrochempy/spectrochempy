...
Computation times
=================
**00:14.432** total execution time for 8 files **from gettingstarted/examples/gallery/auto_examples_core/c_importer**:
...
.. container::
   ...
   * - :ref:`sphx_glr_gettingstarted_examples_gallery_auto_examples_core_c_importer_plot_read_IR_from_opus.py` (``plot_read_IR_from_opus.py``)
     - 00:00.242
     - 0.0
   * - :ref:`sphx_glr_gettingstarted_examples_gallery_auto_examples_core_c_importer_plot_read_perkinelmer.py` (``plot_read_perkinelmer.py``)
     - 00:00.116
     - 0.0
