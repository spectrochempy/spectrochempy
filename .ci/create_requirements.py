...
if __name__ == "__main__":
    ...
    env_main = repo_path / ".ci" / "templates" / "environment.tmpl"
    env_dependencies = repo_path / ".ci" / "templates" / "dependencies.tmpl"
    template_content = env_main.read_text("utf-8") + env_dependencies.read_text("utf-8")
...
""".lstrip()
    ...
    out = template.render(
        DEV=False, DASH=args.dash, CANTERA=args.cantera, HEADER=header
    )
