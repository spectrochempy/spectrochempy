...
def spectrochempy_validate(func_name: str):
    ...
    """
    doc = SpectroChemPyDocstring(func_name)
    result = validate(func_name)

    mentioned_errs = doc.mentioned_private_classes
    if mentioned_errs:
        result["errors"].append(
            spectrochempy_error("GL04", mentioned_private_classes=", ".join(mentioned_errs))
        )
...
if __name__ == "__main__":
    ...
    argparser.add_argument(
        ...
        'will be validated. A prefix "spectrochempy.Project."'
