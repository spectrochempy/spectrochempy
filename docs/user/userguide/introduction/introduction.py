...
# %%
scp.NDDataset.linspace(-5, 5, 50, endpoint=True) # create a rank 1 NDDataset of 50 values evenly spaced between -5 and 5
...
# %%
a = scp.NDDataset.full((5, 3), 10.)  # A 2D table with 5 rows and 3 columns
