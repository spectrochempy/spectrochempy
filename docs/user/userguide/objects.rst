...
**SpectroChemPy** provides another kind of data structure, aggregating several datasets: **NDPanel**.

Finally, **Project** is a structure that allow agregating NDDatasets, NDPanels and processing scripts (Script) for a
better
management of complex set of spectroscopic data.
