...
# method for dimensionality reduction. resolving a set (or several sets) of spectra $X$ of an evolving
...
# $$ X = L P^t + E $$
#
# In this tutorial, the application of PCA as implemented in Scpy to a 'classical'
# dataset from the literature
#
# ## The dataset
#
# Here, we perform the PACA of a dataset corresponding to
