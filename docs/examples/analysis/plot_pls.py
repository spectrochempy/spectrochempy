...
-------------------------------
In this example, we perform a PLS regression of corn spectra to predict
dataset
...
# %%
# Load a dataset
dataset = scp.read_remote("http://www.eigenvector.com/data/Corn/corn.mat")

# %%
# The dataset named `'m5spec'`, corresponding to the 80 spectra
# Let's name assign these specta to `X` , add few informations about the x-scale and plot it:
# %%
X = A[-3]
X.title = "absorbance"
