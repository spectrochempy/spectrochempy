...
# %%
# The score plots can be used for classification purposes. The first one - in 2D for
# the 2 first PC's - shows that the first PC allows distinguishing Iris-setosa (score
# of PC#1 < -1) from other species (score of PC#1 > -1), while more PC's are required
