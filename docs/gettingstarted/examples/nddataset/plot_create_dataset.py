...
mydataset = scp.NDDataset(data=nd_data, coordset=[coord0, coord1, coord2], title="Absorbance", units="absorbance",
                          name="An example from scratch", author="Blake and Mortimer", description=description,
