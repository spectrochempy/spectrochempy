...
# singleton coordinate may inherit the coordinate of the axis that expands it;
# a significant singleton coordinate and duplicate result dimension names are
# rejected explicitly.
